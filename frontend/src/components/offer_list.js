        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group controlId="formMinGar">
              ...
              <Form.Control
                type="text"
                placeholder="Enter minimum GAR"
                name="min_gar"
                value={newOfferData.min_gar}
                onChange={handleInputChange}
              />
            </Form.Group>
            <Form.Group controlId="formMaxGar">
              ...
              <Form.Control
                type="text"
                placeholder="Enter maximum GAR"
                name="max_gar"
                value={newOfferData.max_gar}
                onChange={handleInputChange}
              />
            </Form.Group>
            <Form.Group controlId="formMinAsh">
              ...
              <Form.Control
                type="text"
                placeholder="Enter minimum ASH"
                name="min_ash"
                value={newOfferData.min_ash}
                onChange={handleInputChange}
              />
            </Form.Group>
            <Form.Group controlId="formMaxAsh">
              ...
              <Form.Control
                type="text"
                placeholder="Enter maximum ASH"
                name="max_ash"
                value={newOfferData.max_ash}
                onChange={handleInputChange}
              />
            </Form.Group>
            <Form.Group controlId="formIsMaxAshNull">
              <Form.Check
                type="checkbox"
                label="Is Max ASH Null?"
                name="is_max_ash_null"
                checked={newOfferData.is_max_ash_null}
                onChange={handleInputChange}
              />
            </Form.Group>
